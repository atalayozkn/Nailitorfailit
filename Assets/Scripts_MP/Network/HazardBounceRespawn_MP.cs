// ============================================================
// File:    HazardBounceRespawn_MP.cs
// Author:  Tarık + Murad
// Created: 30-Jun-2026
// Purpose: Handles player respawn and bounce mechanics when interacting with hazards in a multiplayer game using Mirror networking
// ============================================================
...
[RequireComponent(typeof(PlayerMove_MP))]
public class HazardBounceRespawn_MP : NetworkBehaviour
{
    [Header("Trap")]
    ...
    private PlayerMove_MP playerMove;
    ...
    private void Awake()
    {
        ...
        playerMove = GetComponent<PlayerMove_MP>();
